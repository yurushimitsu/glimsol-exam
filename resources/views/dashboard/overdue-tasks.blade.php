...
@section('title', 'Glimsol Task Management | Overdue Tasks')
                                        ...
                                        <form method="POST" action="{{ route('tasks.store') }}" id="createTask" class="p-4 md:p-5">
                                            ...
                                            <div class="grid gap-4 mb-4 grid-cols-2">
                                                <div class="col-span-2">
                                                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900">Title <span class="text-red-300">*</span></label>
                                                ...
                                                <div class="col-span-2">
                                                    <label for="due_date" class="block mb-2 text-sm font-medium text-gray-900">Due Date <span class="text-red-300">*</span></label>
                            ...
                            @foreach ($overdueTasks as $task)
                                <div class="task-card grid grid-cols-1 bg-white rounded-xl p-4 shadow-lg h-40 w-40 select-none hover:bg-gray-50" data-id="{{ $task->id }}" id="task-{{ $task->id }}" title="{{ $task->title }}">
                                    <div class="flex items-start justify-between">
                                        <div class="bg-orange-200 rounded-full text-xs font-light px-3 py-0.5">
                                            Overdue
                                        </div>
                                        <div>
                                            <div class="flex justify-end">
                                                ...
                                                <div id="optionDropdown-{{ $task->id }}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm">
                                                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="optionButton-{{ $task->id }}">
                                                        <li>
                                                            <button type="button" onclick="markAsPendingOverdue({{ $task->id }})" class="block px-4 py-2 cursor-pointer hover:bg-gray-100 text-start w-full">
                                                                Mark As Pending
                                                            </button>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                                        <div class="relative bg-white rounded-lg shadow-sm">
                                                            ...
                                                            <form method="POST" action="{{ route('tasks.update', $task->id) }}" id="editTask" class="p-4 md:p-5">
                                                                ...
                                                                <div class="grid gap-4 mb-4 grid-cols-2">
                                                                    <div class="col-span-2">
                                                                        <label for="edit-title" class="block mb-2 text-sm font-medium text-gray-900">Title <span class="text-red-300">*</span></label>
                                                                ...
                                                                <div class="flex justify-end gap-1">
                                                                    ...
                                                                    <button type="button" id="edit-button-{{ $task->id }}" onclick="enableEdit({{ $task->id }})" class="text-white inline-flex items-center bg-blue-500 hover:bg-blue-600 cursor-pointer focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-5 py-2.5 text-center">
                                                                        Edit
                                                                    </button>
                                                                    <button type="submit" id="save-edit-button-{{ $task->id }}" class="!hidden text-white inline-flex items-center bg-blue-500 hover:bg-blue-600 cursor-pointer focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-5 py-2.5 text-center">
                                                                        Save
                                                                    </button>
                                                                </div>
                                                            </form>
